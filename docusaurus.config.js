...
const config = {
  ...
  organizationName: 'markus-ap', // Usually your GitHub org/user name.
  projectName: 'dylgja.no', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/markus-ap/dylgja.no/tree/main/',
        },
        blog: {
